...
.method private constructor <init>(I)V
    ...
    iput-byte v0, p0, Lcom/itextpdf/text/pdf/qrcode/FormatInformation;->dataMask:B

    .line 83
    return-void
.end method

.method static decodeFormatInformation(II)Lcom/itextpdf/text/pdf/qrcode/FormatInformation;
    .locals 3
    ...
    .line 107
    .local v0, formatInfo:Lcom/itextpdf/text/pdf/qrcode/FormatInformation;
    if-eqz v0, :cond_0

    .line 113
    .end local v0           #formatInfo:Lcom/itextpdf/text/pdf/qrcode/FormatInformation;
    :goto_0
    return-object v0

    .restart local v0       #formatInfo:Lcom/itextpdf/text/pdf/qrcode/FormatInformation;
    :cond_0
    xor-int/lit16 v1, p0, 0x5412

    xor-int/lit16 v2, p1, 0x5412

    invoke-static {v1, v2}, Lcom/itextpdf/text/pdf/qrcode/FormatInformation;->doDecodeFormatInformation(II)Lcom/itextpdf/text/pdf/qrcode/FormatInformation;
...
.method private static doDecodeFormatInformation(II)Lcom/itextpdf/text/pdf/qrcode/FormatInformation;
    ...
    .local v4, i:I
    :goto_0
    sget-object v6, Lcom/itextpdf/text/pdf/qrcode/FormatInformation;->FORMAT_INFO_DECODE_LOOKUP:[[I
    ...
    .line 126
    :cond_0
    new-instance v6, Lcom/itextpdf/text/pdf/qrcode/FormatInformation;

    aget v7, v3, v7

    invoke-direct {v6, v7}, Lcom/itextpdf/text/pdf/qrcode/FormatInformation;-><init>(I)V
    ...
    invoke-direct {v6, v1}, Lcom/itextpdf/text/pdf/qrcode/FormatInformation;-><init>(I)V
...
.method static numBitsDiffering(II)I
    ...
    .line 88
    sget-object v0, Lcom/itextpdf/text/pdf/qrcode/FormatInformation;->BITS_SET_IN_HALF_BYTE:[I

    and-int/lit8 v1, p0, 0xf

    aget v0, v0, v1

    sget-object v1, Lcom/itextpdf/text/pdf/qrcode/FormatInformation;->BITS_SET_IN_HALF_BYTE:[I
...
.method public equals(Ljava/lang/Object;)Z
    ...
    .line 163
    instance-of v2, p1, Lcom/itextpdf/text/pdf/qrcode/FormatInformation;
    ...
    .line 166
    check-cast v0, Lcom/itextpdf/text/pdf/qrcode/FormatInformation;

    .line 167
    .local v0, other:Lcom/itextpdf/text/pdf/qrcode/FormatInformation;
    iget-object v2, p0, Lcom/itextpdf/text/pdf/qrcode/FormatInformation;->errorCorrectionLevel:Lcom/itextpdf/text/pdf/qrcode/ErrorCorrectionLevel;

    iget-object v3, v0, Lcom/itextpdf/text/pdf/qrcode/FormatInformation;->errorCorrectionLevel:Lcom/itextpdf/text/pdf/qrcode/ErrorCorrectionLevel;

    if-ne v2, v3, :cond_0

    iget-byte v2, p0, Lcom/itextpdf/text/pdf/qrcode/FormatInformation;->dataMask:B

    iget-byte v3, v0, Lcom/itextpdf/text/pdf/qrcode/FormatInformation;->dataMask:B
...
.method getErrorCorrectionLevel()Lcom/itextpdf/text/pdf/qrcode/ErrorCorrectionLevel;
    .locals 1
