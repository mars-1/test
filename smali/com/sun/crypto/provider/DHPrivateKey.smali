.class final Lcom/sun/crypto/provider/DHPrivateKey;
...
# static fields
.field private static final PKCS8_VERSION:Ljava/math/BigInteger; = null

.field static final serialVersionUID:J = 0x68fdf9c8d4775c16L
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/sun/crypto/provider/DHPrivateKey;->PKCS8_VERSION:Ljava/math/BigInteger;
...
.method constructor <init>(Ljava/math/BigInteger;Ljava/math/BigInteger;Ljava/math/BigInteger;)V
    ...
    invoke-direct {p0, p1, p2, p3, v0}, Lcom/sun/crypto/provider/DHPrivateKey;-><init>(Ljava/math/BigInteger;Ljava/math/BigInteger;Ljava/math/BigInteger;I)V
...
.method constructor <init>(Ljava/math/BigInteger;Ljava/math/BigInteger;Ljava/math/BigInteger;I)V
    ...
    iput-object v0, p0, Lcom/sun/crypto/provider/DHPrivateKey;->DH_data:[I

    iput-object p1, p0, Lcom/sun/crypto/provider/DHPrivateKey;->x:Ljava/math/BigInteger;

    iput-object p2, p0, Lcom/sun/crypto/provider/DHPrivateKey;->p:Ljava/math/BigInteger;

    iput-object p3, p0, Lcom/sun/crypto/provider/DHPrivateKey;->g:Ljava/math/BigInteger;

    iput p4, p0, Lcom/sun/crypto/provider/DHPrivateKey;->l:I
    ...
    iget-object v2, p0, Lcom/sun/crypto/provider/DHPrivateKey;->x:Ljava/math/BigInteger;
    ...
    iput-object v0, p0, Lcom/sun/crypto/provider/DHPrivateKey;->key:[B

    invoke-virtual {p0}, Lcom/sun/crypto/provider/DHPrivateKey;->getEncoded()[B

    move-result-object v0

    iput-object v0, p0, Lcom/sun/crypto/provider/DHPrivateKey;->encodedKey:[B
    :try_end_0
...
.method constructor <init>([B)V
    ...
    const-string/jumbo v1, "Key not a SEQUENCE"
    ...
    const-string/jumbo v2, "Private-value length too big"
    ...
    sget-object v2, Lcom/sun/crypto/provider/DHPrivateKey;->PKCS8_VERSION:Ljava/math/BigInteger;
    ...
    sget-object v3, Lcom/sun/crypto/provider/DHPrivateKey;->PKCS8_VERSION:Ljava/math/BigInteger;
    ...
    iput-object v2, p0, Lcom/sun/crypto/provider/DHPrivateKey;->p:Ljava/math/BigInteger;
    ...
    iput-object v2, p0, Lcom/sun/crypto/provider/DHPrivateKey;->g:Ljava/math/BigInteger;
    ...
    iput v2, p0, Lcom/sun/crypto/provider/DHPrivateKey;->l:I
    ...
    invoke-direct {p0}, Lcom/sun/crypto/provider/DHPrivateKey;->parseKeyBits()V
...
.method private parseKeyBits()V
    ...
    iget-object v1, p0, Lcom/sun/crypto/provider/DHPrivateKey;->key:[B
    ...
    iput-object v0, p0, Lcom/sun/crypto/provider/DHPrivateKey;->x:Ljava/math/BigInteger;
    :try_end_0
    .catch Ljava/io/IOException; {:try_start_0 .. :try_end_0} :catch_0
...
.method private writeReplace()Ljava/lang/Object;
    ...
    invoke-virtual {p0}, Lcom/sun/crypto/provider/DHPrivateKey;->getAlgorithm()Ljava/lang/String;

    move-result-object v2

    invoke-virtual {p0}, Lcom/sun/crypto/provider/DHPrivateKey;->getFormat()Ljava/lang/String;
...
.method public declared-synchronized getEncoded()[B
    ...
    :try_start_0
    iget-object v0, p0, Lcom/sun/crypto/provider/DHPrivateKey;->encodedKey:[B
    :try_end_0
    ...
    sget-object v1, Lcom/sun/crypto/provider/DHPrivateKey;->PKCS8_VERSION:Ljava/math/BigInteger;
    ...
    iget-object v3, p0, Lcom/sun/crypto/provider/DHPrivateKey;->DH_data:[I
    ...
    iget-object v3, p0, Lcom/sun/crypto/provider/DHPrivateKey;->p:Ljava/math/BigInteger;

    invoke-virtual {v2, v3}, Lsun/security/util/DerOutputStream;->putInteger(Ljava/math/BigInteger;)V

    iget-object v3, p0, Lcom/sun/crypto/provider/DHPrivateKey;->g:Ljava/math/BigInteger;

    invoke-virtual {v2, v3}, Lsun/security/util/DerOutputStream;->putInteger(Ljava/math/BigInteger;)V

    iget v3, p0, Lcom/sun/crypto/provider/DHPrivateKey;->l:I
    ...
    invoke-direct {v3, v4, v2}, Lsun/security/util/DerValue;-><init>(B[B)V

    invoke-virtual {v1, v3}, Lsun/security/util/DerOutputStream;->putDerValue(Lsun/security/util/DerValue;)V
...
.method public getParams()Ljavax/crypto/spec/DHParameterSpec;
    ...
    iget v0, p0, Lcom/sun/crypto/provider/DHPrivateKey;->l:I

    if-eqz v0, :cond_0

    new-instance v0, Ljavax/crypto/spec/DHParameterSpec;

    iget-object v1, p0, Lcom/sun/crypto/provider/DHPrivateKey;->p:Ljava/math/BigInteger;

    iget-object v2, p0, Lcom/sun/crypto/provider/DHPrivateKey;->g:Ljava/math/BigInteger;
...
.method public getX()Ljava/math/BigInteger;
    ...
    iget-object v0, p0, Lcom/sun/crypto/provider/DHPrivateKey;->x:Ljava/math/BigInteger;
...
.method public toString()Ljava/lang/String;
    ...
    const-string/jumbo v3, "SunJCE Diffie-Hellman Private Key:"
    ...
    iget-object v3, p0, Lcom/sun/crypto/provider/DHPrivateKey;->x:Ljava/math/BigInteger;
    ...
    iget v2, p0, Lcom/sun/crypto/provider/DHPrivateKey;->l:I
