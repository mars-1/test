...
.method public constructor <init>(Lcom/thoughtworks/xstream/mapper/Mapper;Ljava/lang/String;Ljava/lang/String;Ljava/lang/Class;Ljava/lang/String;Ljava/lang/Class;ZZLcom/thoughtworks/xstream/converters/ConverterLookup;)V
    ...
    .parameter "valueName"
    .parameter "valueType"
    .parameter "keyAsAttribute"
    .parameter "valueAsAttribute"
    .parameter "lookup"
...
.method public constructor <init>(Ljava/lang/Class;Lcom/thoughtworks/xstream/mapper/Mapper;Ljava/lang/String;Ljava/lang/String;Ljava/lang/Class;Ljava/lang/String;Ljava/lang/Class;ZZLcom/thoughtworks/xstream/converters/ConverterLookup;)V
    ...
    const-string/jumbo v1, "Class types of key and value are mandatory"
    ...
    const-string/jumbo v1, "Cannot write attributes to map entry, if map entry must be omitted"
    ...
    const-string/jumbo v1, "Cannot write value as text of entry, if entry must be omitted"
    ...
    const-string/jumbo v1, "Cannot write key without name"
    ...
    const-string/jumbo v1, "Cannot write value as attribute without name"
    ...
    const-string/jumbo v1, "Cannot write value as text of entry, if key is also child element"
    ...
    const-string/jumbo v1, "Cannot write key and value with same attribute name"
...
.method private getSingleValueConverter(Ljava/lang/Class;)Lcom/thoughtworks/xstream/converters/SingleValueConverter;
    ...
    const-string/jumbo v3, "No SingleValueConverter for key available"
