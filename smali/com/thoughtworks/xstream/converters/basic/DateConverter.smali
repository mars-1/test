...
.method static constructor <clinit>()V
    ...
    const-string/jumbo v2, "yyyy-MM-dd G HH:mm:ss.S z"
    ...
    const-string/jumbo v5, "yyyy-MM-dd HH:mm:ss.S z"
    ...
    const-string/jumbo v5, "yyyy-MM-dd G HH:mm:ss.S z"
    ...
    .line 66
    :cond_0
    const-string/jumbo v5, "yyyy-MM-dd HH:mm:ss.S a"
    ...
    .line 71
    const-string/jumbo v5, "yyyy-MM-dd HH:mm:ss \'UTC\'"

    invoke-interface {v0, v5}, Ljava/util/List;->add(Ljava/lang/Object;)Z

    .line 74
    :cond_1
    const-string/jumbo v5, "yyyy-MM-dd HH:mm:ssa"
    ...
    :cond_2
    const-string/jumbo v5, "yyyy-MM-dd HH:mm:ss.S \'UTC\'"

    goto :goto_0

    .line 61
    :cond_3
    const-string/jumbo v5, "yyyy-MM-dd G HH:mm:ss.S \'UTC\'"
...
.method public constructor <init>(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;Ljava/util/Locale;Ljava/util/TimeZone;Z)V
    .locals 8
    .parameter "defaultEraFormat"
    .parameter "defaultFormat"
    .parameter "acceptableFormats"
    .parameter "locale"
    .parameter "timeZone"
    .parameter "lenient"
...
.method public appendErrors(Lcom/thoughtworks/xstream/converters/ErrorWriter;)V
    ...
    .prologue
    .line 236
    const-string/jumbo v1, "Default date pattern"
    ...
    .line 238
    const-string/jumbo v1, "Default era date pattern"
    ...
    .line 241
    const-string/jumbo v1, "Alternative date pattern"
...
.method public fromString(Ljava/lang/String;)Ljava/lang/Object;
    ...
    const-string/jumbo v3, "Cannot parse date "
