.class Lcom/cnlaunch/framework/network/http/RetryHandler;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/cnlaunch/framework/network/http/RetryHandler;->exceptionWhitelist:Ljava/util/HashSet;
    ...
    sput-object v0, Lcom/cnlaunch/framework/network/http/RetryHandler;->exceptionBlacklist:Ljava/util/HashSet;

    .line 48
    sget-object v0, Lcom/cnlaunch/framework/network/http/RetryHandler;->exceptionWhitelist:Ljava/util/HashSet;
    ...
    .line 55
    sget-object v0, Lcom/cnlaunch/framework/network/http/RetryHandler;->exceptionBlacklist:Ljava/util/HashSet;
...
.method public constructor <init>(II)V
    ...
    .line 64
    iput p1, p0, Lcom/cnlaunch/framework/network/http/RetryHandler;->maxRetries:I

    .line 65
    iput p2, p0, Lcom/cnlaunch/framework/network/http/RetryHandler;->retrySleepTimeMS:I
...
.method public retryRequest(Ljava/io/IOException;ILorg/apache/http/protocol/HttpContext;)Z
    ...
    .line 72
    .local v3, retry:Z
    const-string/jumbo v7, "http.request_sent"
    ...
    .local v4, sent:Z
    :goto_0
    iget v7, p0, Lcom/cnlaunch/framework/network/http/RetryHandler;->maxRetries:I
    ...
    :cond_2
    sget-object v7, Lcom/cnlaunch/framework/network/http/RetryHandler;->exceptionBlacklist:Ljava/util/HashSet;

    invoke-virtual {p0, v7, p1}, Lcom/cnlaunch/framework/network/http/RetryHandler;->isInList(Ljava/util/HashSet;Ljava/lang/Throwable;)Z
    ...
    :cond_3
    sget-object v7, Lcom/cnlaunch/framework/network/http/RetryHandler;->exceptionWhitelist:Ljava/util/HashSet;
    ...
    .line 100
    iget v5, p0, Lcom/cnlaunch/framework/network/http/RetryHandler;->retrySleepTimeMS:I
