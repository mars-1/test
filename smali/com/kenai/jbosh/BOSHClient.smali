...
.method static constructor <clinit>()V
    ...
    const-string/jumbo v3, ".emptyRequestDelay"
    ...
    const-string/jumbo v3, ".pauseMargin"
    ...
    const-string/jumbo v3, ".assertionsEnabled"
...
.method private assertLocked()V
    ...
    const-string/jumbo v1, "Lock is not held by current thread"
...
.method private assertUnlocked()V
    ...
    const-string/jumbo v1, "Lock is held by current thread"
...
.method private checkForTerminalBindingConditions(Lcom/kenai/jbosh/AbstractBody;I)V
    ...
    const-string/jumbo v3, "Terminal binding condition encountered: "
...
.method public static create(Lcom/kenai/jbosh/BOSHClientConfig;)Lcom/kenai/jbosh/BOSHClient;
    ...
    .line 365
    const-string/jumbo v1, "Client configuration may not be null"
...
.method private fireConnectionEstablished()V
    ...
    const-string/jumbo v7, "Unhandled Exception"
...
.method private init()V
    ...
    .line 668
    const-string/jumbo v2, "]: Receive thread"
...
.method private processExchange(Lcom/kenai/jbosh/HTTPExchange;)V
    ...
    .line 1031
    .local v11, resp:Lcom/kenai/jbosh/HTTPResponse;
    invoke-interface {v11}, Lcom/kenai/jbosh/HTTPResponse;->getBody()Lcom/kenai/jbosh/AbstractBody;

    move-result-object v3

    .line 1032
    .local v3, body:Lcom/kenai/jbosh/AbstractBody;
    invoke-interface {v11}, Lcom/kenai/jbosh/HTTPResponse;->getHTTPStatus()I
    :try_end_0
    ...
    invoke-direct {v0, v3}, Lcom/kenai/jbosh/BOSHClient;->fireResponseReceived(Lcom/kenai/jbosh/AbstractBody;)V
    ...
    .line 1047
    .local v8, req:Lcom/kenai/jbosh/AbstractBody;
    const/4 v14, 0x0

    .line 1048
    .local v14, toResend:Ljava/util/List;,"Ljava/util/List<Lcom/kenai/jbosh/HTTPExchange;>;"
    move-object/from16 v0, p0
    ...
    .line 1052
    invoke-static {v8, v3}, Lcom/kenai/jbosh/CMSessionParams;->fromSessionInit(Lcom/kenai/jbosh/AbstractBody;Lcom/kenai/jbosh/AbstractBody;)Lcom/kenai/jbosh/CMSessionParams;
    ...
    iget-object v7, v0, Lcom/kenai/jbosh/BOSHClient;->cmParams:Lcom/kenai/jbosh/CMSessionParams;

    .line 1059
    .local v7, params:Lcom/kenai/jbosh/CMSessionParams;
    move-object/from16 v0, p0

    invoke-direct {v0, v3, v12}, Lcom/kenai/jbosh/BOSHClient;->checkForTerminalBindingConditions(Lcom/kenai/jbosh/AbstractBody;I)V

    .line 1060
    invoke-static {v3}, Lcom/kenai/jbosh/BOSHClient;->isTermination(Lcom/kenai/jbosh/AbstractBody;)Z
    ...
    invoke-direct {v0, v8}, Lcom/kenai/jbosh/BOSHClient;->processPauseRequest(Lcom/kenai/jbosh/AbstractBody;)J
    ...
    .line 1119
    .end local v3           #body:Lcom/kenai/jbosh/AbstractBody;
    .end local v7           #params:Lcom/kenai/jbosh/CMSessionParams;
    .end local v8           #req:Lcom/kenai/jbosh/AbstractBody;
    .end local v11           #resp:Lcom/kenai/jbosh/HTTPResponse;
    .end local v12           #respCode:I
    .end local v14           #toResend:Ljava/util/List;,"Ljava/util/List<Lcom/kenai/jbosh/HTTPExchange;>;"
    :cond_2
    :goto_0
    return-void
    ...
    .line 1034
    .local v4, boshx:Lcom/kenai/jbosh/BOSHException;
    sget-object v16, Lcom/kenai/jbosh/BOSHClient;->LOG:Ljava/util/logging/Logger;

    sget-object v17, Ljava/util/logging/Level;->FINEST:Ljava/util/logging/Level;

    const-string/jumbo v18, "Could not obtain response"
    ...
    invoke-direct {v0, v4}, Lcom/kenai/jbosh/BOSHClient;->dispose(Ljava/lang/Throwable;)V

    goto :goto_0

    .line 1037
    .end local v4           #boshx:Lcom/kenai/jbosh/BOSHException;
    :catch_1
    move-exception v6

    .line 1038
    .local v6, intx:Ljava/lang/InterruptedException;
    sget-object v16, Lcom/kenai/jbosh/BOSHClient;->LOG:Ljava/util/logging/Logger;

    sget-object v17, Ljava/util/logging/Level;->FINEST:Ljava/util/logging/Level;

    const-string/jumbo v18, "Interrupted"
    ...
    invoke-direct {v0, v6}, Lcom/kenai/jbosh/BOSHClient;->dispose(Ljava/lang/Throwable;)V

    goto :goto_0

    .line 1105
    .end local v6           #intx:Ljava/lang/InterruptedException;
    .restart local v3       #body:Lcom/kenai/jbosh/AbstractBody;
    .restart local v7       #params:Lcom/kenai/jbosh/CMSessionParams;
    .restart local v8       #req:Lcom/kenai/jbosh/AbstractBody;
    .restart local v11       #resp:Lcom/kenai/jbosh/HTTPResponse;
    .restart local v12       #respCode:I
    .restart local v14       #toResend:Ljava/util/List;,"Ljava/util/List<Lcom/kenai/jbosh/HTTPExchange;>;"
    :catchall_0
    move-exception v16
    ...
    :cond_3
    :try_start_3
    invoke-static {v3}, Lcom/kenai/jbosh/BOSHClient;->isRecoverableBindingCondition(Lcom/kenai/jbosh/AbstractBody;)Z
    ...
    invoke-interface/range {v16 .. v16}, Ljava/util/Queue;->iterator()Ljava/util/Iterator;
    ...
    check-cast v9, Lcom/kenai/jbosh/HTTPExchange;

    .line 1114
    .local v9, resend:Lcom/kenai/jbosh/HTTPExchange;
    move-object/from16 v0, p0
    ...
    invoke-virtual {v9}, Lcom/kenai/jbosh/HTTPExchange;->getRequest()Lcom/kenai/jbosh/AbstractBody;
    ...
    invoke-interface {v0, v7, v1}, Lcom/kenai/jbosh/HTTPSender;->send(Lcom/kenai/jbosh/CMSessionParams;Lcom/kenai/jbosh/AbstractBody;)Lcom/kenai/jbosh/HTTPResponse;

    move-result-object v13

    .line 1115
    .local v13, response:Lcom/kenai/jbosh/HTTPResponse;
    invoke-virtual {v9, v13}, Lcom/kenai/jbosh/HTTPExchange;->setHTTPResponse(Lcom/kenai/jbosh/HTTPResponse;)V
    ...
    .line 1072
    .end local v9           #resend:Lcom/kenai/jbosh/HTTPExchange;
    .end local v13           #response:Lcom/kenai/jbosh/HTTPResponse;
    :cond_8
    :try_start_5
    invoke-interface/range {v16 .. v16}, Ljava/util/Iterator;->next()Ljava/lang/Object;
    ...
    check-cast v5, Lcom/kenai/jbosh/HTTPExchange;

    .line 1074
    .local v5, exchange:Lcom/kenai/jbosh/HTTPExchange;
    new-instance v10, Lcom/kenai/jbosh/HTTPExchange;

    invoke-virtual {v5}, Lcom/kenai/jbosh/HTTPExchange;->getRequest()Lcom/kenai/jbosh/AbstractBody;

    move-result-object v17

    move-object/from16 v0, v17

    invoke-direct {v10, v0}, Lcom/kenai/jbosh/HTTPExchange;-><init>(Lcom/kenai/jbosh/AbstractBody;)V

    .line 1075
    .local v10, resendExch:Lcom/kenai/jbosh/HTTPExchange;
    ...
    .line 1092
    .end local v5           #exchange:Lcom/kenai/jbosh/HTTPExchange;
    .end local v7           #params:Lcom/kenai/jbosh/CMSessionParams;
    .end local v10           #resendExch:Lcom/kenai/jbosh/HTTPExchange;
    :catch_2
    move-exception v4

    .line 1093
    .restart local v4       #boshx:Lcom/kenai/jbosh/BOSHException;
    :goto_5
    :try_start_6
    sget-object v16, Lcom/kenai/jbosh/BOSHClient;->LOG:Ljava/util/logging/Logger;
    ...
    const-string/jumbo v18, "Could not process response"
    ...
    .line 1078
    .restart local v5       #exchange:Lcom/kenai/jbosh/HTTPExchange;
    move-object/from16 v0, p0
    ...
    invoke-direct {v0, v8, v3}, Lcom/kenai/jbosh/BOSHClient;->processRequestAcknowledgements(Lcom/kenai/jbosh/AbstractBody;Lcom/kenai/jbosh/AbstractBody;)V

    .line 1083
    move-object/from16 v0, p0

    invoke-direct {v0, v8}, Lcom/kenai/jbosh/BOSHClient;->processResponseAcknowledgementData(Lcom/kenai/jbosh/AbstractBody;)V

    .line 1085
    move-object/from16 v0, p0

    invoke-direct {v0, v3}, Lcom/kenai/jbosh/BOSHClient;->processResponseAcknowledgementReport(Lcom/kenai/jbosh/AbstractBody;)Lcom/kenai/jbosh/HTTPExchange;

    move-result-object v10

    .line 1086
    .restart local v10       #resendExch:Lcom/kenai/jbosh/HTTPExchange;
    if-eqz v10, :cond_5
...
.method private processMessages()V
    ...
    const-string/jumbo v5, "Processing thread starting"
    ...
    const-string/jumbo v5, "Processing thread exiting"
    ...
    const-string/jumbo v6, "Discarding exchange on request of test hook: RID="
    ...
    const-string/jumbo v6, "Processing thread exiting"
...
.method private processPauseRequest(Lcom/kenai/jbosh/AbstractBody;)J
    ...
    .line 1273
    .local v3, pause:Lcom/kenai/jbosh/AttrPause;
    if-eqz v3, :cond_1

    .line 1274
    invoke-virtual {v3}, Lcom/kenai/jbosh/AttrPause;->getInMilliseconds()I
    ...
    .end local v3           #pause:Lcom/kenai/jbosh/AttrPause;
    :cond_0
    :goto_0
    return-wide v1
    ...
    const-string/jumbo v6, "Could not extract"
...
.method private processRequestAcknowledgements(Lcom/kenai/jbosh/AbstractBody;Lcom/kenai/jbosh/AbstractBody;)V
    ...
    const-string/jumbo v7, "Removing pending acks up to: "
...
.method private processResponseAcknowledgementReport(Lcom/kenai/jbosh/AbstractBody;)Lcom/kenai/jbosh/HTTPExchange;
    ...
    const-string/jumbo v10, "Received report of missing request (RID="
    ...
    const-string/jumbo v10, "Report of missing message with RID \'"
    ...
    .line 1407
    const-string/jumbo v10, "\' but local copy of that request was not found"
...
.method private scheduleEmptyRequest(J)V
    ...
    const-string/jumbo v3, "Empty request delay must be >= 0 (was: "
    ...
    const-string/jumbo v3, "Scheduling empty request in "
    ...
    const-string/jumbo v3, "Could not schedule empty request"
...
.method private sendEmptyRequest()V
    ...
    const-string/jumbo v2, "Sending empty request"
...
.method public addBOSHClientConnListener(Lcom/kenai/jbosh/BOSHClientConnListener;)V
    ...
    const-string/jumbo v1, "Listener may not b enull"
...
.method public close()V
    ...
    const-string/jumbo v1, "Session explicitly closed by caller"
...
.method public disconnect(Lcom/kenai/jbosh/ComposableBody;)V
    ...
    .line 583
    const-string/jumbo v2, "Message body may not be null"
...
.method drain()V
    ...
    const-string/jumbo v2, "Waiting while draining..."
...
.method public pause()Z
    ...
    invoke-virtual {v2}, Lcom/kenai/jbosh/CMSessionParams;->getMaxPause()Lcom/kenai/jbosh/AttrMaxPause;
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
    ...
    const-string/jumbo v4, "Could not send pause"
...
.method public send(Lcom/kenai/jbosh/ComposableBody;)V
    ...
    .line 480
    const-string/jumbo v8, "Message body may not be null"
    ...
    .line 485
    :cond_0
    iget-object v7, p0, Lcom/kenai/jbosh/BOSHClient;->lock:Ljava/util/concurrent/locks/ReentrantLock;
    ...
    .line 489
    new-instance v7, Lcom/kenai/jbosh/BOSHException;

    .line 490
    const-string/jumbo v8, "Cannot send message when session is closed"

    .line 489
    invoke-direct {v7, v8}, Lcom/kenai/jbosh/BOSHException;-><init>(Ljava/lang/String;)V
    ...
    :cond_1
    :try_start_1
    iget-object v7, p0, Lcom/kenai/jbosh/BOSHClient;->requestIDSeq:Lcom/kenai/jbosh/RequestIDSequence;

    invoke-virtual {v7}, Lcom/kenai/jbosh/RequestIDSequence;->getNextRID()J
    ...
    iget-object v7, p0, Lcom/kenai/jbosh/BOSHClient;->exchanges:Ljava/util/Queue;
    ...
    .line 498
    invoke-direct {p0, v5, v6, p1}, Lcom/kenai/jbosh/BOSHClient;->applySessionCreationRequest(JLcom/kenai/jbosh/ComposableBody;)Lcom/kenai/jbosh/ComposableBody;
    ...
    .line 507
    iget-object v7, p0, Lcom/kenai/jbosh/BOSHClient;->notEmpty:Ljava/util/concurrent/locks/Condition;
    ...
    iget-object v7, p0, Lcom/kenai/jbosh/BOSHClient;->httpSender:Lcom/kenai/jbosh/HTTPSender;

    invoke-interface {v7, v2, v1}, Lcom/kenai/jbosh/HTTPSender;->send(Lcom/kenai/jbosh/CMSessionParams;Lcom/kenai/jbosh/AbstractBody;)Lcom/kenai/jbosh/HTTPResponse;
    ...
    :cond_3
    :try_start_2
    invoke-direct {p0, v5, v6, p1}, Lcom/kenai/jbosh/BOSHClient;->applySessionData(JLcom/kenai/jbosh/ComposableBody;)Lcom/kenai/jbosh/ComposableBody;

    move-result-object v3

    .line 501
    iget-object v7, p0, Lcom/kenai/jbosh/BOSHClient;->cmParams:Lcom/kenai/jbosh/CMSessionParams;

    invoke-virtual {v7}, Lcom/kenai/jbosh/CMSessionParams;->isAckingRequests()Z
    ...
    .line 502
    iget-object v7, p0, Lcom/kenai/jbosh/BOSHClient;->pendingRequestAcks:Ljava/util/List;
