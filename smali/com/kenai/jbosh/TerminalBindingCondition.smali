...
.method static constructor <clinit>()V
    ...
    const-string/jumbo v1, "The format of an HTTP header or binding element received from the client is unacceptable (e.g., syntax error)."
    ...
    .line 45
    const-string/jumbo v0, "host-gone"

    const-string/jumbo v1, "The target domain specified in the \'to\' attribute or the target host or port specified in the \'route\' attribute is no longer serviced by the connection manager."
    ...
    .line 50
    const-string/jumbo v0, "host-unknown"

    const-string/jumbo v1, "The target domain specified in the \'to\' attribute or the target host or port specified in the \'route\' attribute is unknown to the connection manager."
    ...
    .line 55
    const-string/jumbo v0, "improper-addressing"

    const-string/jumbo v1, "The initialization element lacks a \'to\' or \'route\' attribute (or the attribute has no value) but the connection manager requires one."
    ...
    const-string/jumbo v1, "The connection manager has experienced an internal error that prevents it from servicing the request."
    ...
    .line 65
    const-string/jumbo v0, "item-not-found"

    const-string/jumbo v1, "(1) \'sid\' is not valid, (2) \'stream\' is not valid, (3) \'rid\' is larger than the upper limit of the expected window, (4) connection manager is unable to resend response, (5) \'key\' sequence is invalid."
    ...
    .line 72
    const-string/jumbo v0, "other-request"

    const-string/jumbo v1, "Another request being processed at the same time as this request caused the session to terminate."
    ...
    .line 76
    const-string/jumbo v0, "policy-violation"

    const-string/jumbo v1, "The client has broken the session rules (polling too frequently, requesting too frequently, sending too many simultaneous requests)."
    ...
    .line 82
    const-string/jumbo v0, "remote-connection-failed"

    const-string/jumbo v1, "The connection manager was unable to connect to, or unable to connect securely to, or has lost its connection to, the server."
    ...
    .line 87
    const-string/jumbo v0, "remote-stream-error"

    const-string/jumbo v1, "Encapsulated transport protocol error."
    ...
    .line 91
    const-string/jumbo v0, "see-other-uri"

    const-string/jumbo v1, "The connection manager does not operate at this URI (e.g., the connection manager accepts only SSL or TLS connections at some https: URI rather than the http: URI requested by the client)."
    ...
    .line 97
    const-string/jumbo v0, "system-shutdown"

    const-string/jumbo v1, "The connection manager is being shut down. All active HTTP sessions are being terminated. No new sessions can be created."
    ...
    .line 102
    const-string/jumbo v0, "undefined-condition"

    const-string/jumbo v1, "Unknown or undefined error condition."
...
.method private static createWithCode(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Integer;)Lcom/kenai/jbosh/TerminalBindingCondition;
    ...
    .line 143
    const-string/jumbo v2, "condition may not be null"
    ...
    .line 147
    const-string/jumbo v2, "message may not be null"
    ...
    const-string/jumbo v3, "Multiple definitions of condition: "
    ...
    const-string/jumbo v3, "Multiple definitions of code: "
