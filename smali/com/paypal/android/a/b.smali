...
.method private B()Z
    ...
    const-string/jumbo v4, "/DeviceInterrogation"
    ...
    const-string/jumbo v4, "MPL"

    const-string/jumbo v5, "start makeDeviceInterrogationRequest Post"
    ...
    const-string/jumbo v5, "MPL"

    const-string/jumbo v6, "end makeDeviceInterrogationRequest Post"
    ...
    const-string/jumbo v1, "makeDeviceInterrogationRequest"
    ...
    const-string/jumbo v4, "makeDeviceInterrogationRequest"
    ...
    const-string/jumbo v2, "NetworkHandler"

    new-instance v3, Ljava/lang/StringBuilder;

    invoke-direct {v3}, Ljava/lang/StringBuilder;-><init>()V

    const-string/jumbo v4, "makeDeviceInterrogationRequest caught exception "
    ...
    const-string/jumbo v1, "NetworkHandler"

    const-string/jumbo v2, "makeDeviceInterrogationRequest something failed"
...
.method private C()Z
    ...
    const-string/jumbo v3, "/DeviceCreatePin"
    ...
    :cond_0
    const-string/jumbo v1, "createPIN"
    ...
    const-string/jumbo v3, "createPIN caught BadXMLException "
    ...
    const-string/jumbo v3, "createPIN caught BadPhoneNumberException "
...
.method private D()Z
    ...
    const-string/jumbo v4, "/RemoveDeviceAuthorization"
    ...
    const-string/jumbo v4, "readRemoveDeviceAuthorization caught exception "
...
.method private a(Ljava/lang/String;Ljava/lang/String;Z)Ljava/lang/String;
    ...
    const-string/jumbo v5, "No cert"

    invoke-virtual {v2, v3, v5}, Lorg/apache/http/client/methods/HttpPost;->setHeader(Ljava/lang/String;Ljava/lang/String;)V

    iget-object v2, p0, Lcom/paypal/android/a/b;->c:Lorg/apache/http/client/methods/HttpPost;

    const-string/jumbo v3, "X-PAYPAL-MESSAGE-PROTOCOL"

    const-string/jumbo v5, "SOAP11"

    invoke-virtual {v2, v3, v5}, Lorg/apache/http/client/methods/HttpPost;->setHeader(Ljava/lang/String;Ljava/lang/String;)V

    iget-object v2, p0, Lcom/paypal/android/a/b;->c:Lorg/apache/http/client/methods/HttpPost;

    const-string/jumbo v3, "X-PAYPAL-APPLICATION-ID"
    ...
    const-string/jumbo v3, "X-PAYPAL-REQUEST-SOURCE"
    ...
    const-string/jumbo v3, "x-paypal-element-ordering-preserve"
    ...
    const-string/jumbo v2, "postXML do execute"
    ...
    const-string/jumbo v3, "X-PAYPAL-DEVICE-IPADDRESS"
    ...
    const-string/jumbo v3, "X-PAYPAL-DEVICE-AUTH-TOKEN"
    ...
    :goto_3
    :try_start_1
    const-string/jumbo v5, "NetworkHandler"

    new-instance v6, Ljava/lang/StringBuilder;

    invoke-direct {v6}, Ljava/lang/StringBuilder;-><init>()V

    const-string/jumbo v7, "postXML caught exception doing I/O, "
    ...
    const-string/jumbo v3, "X-PAYPAL-SECURITY-PASSWORD"
    ...
    const-string/jumbo v3, "X-PAYPAL-SECURITY-USERID"
    ...
    const-string/jumbo v3, "X-PAYPAL-SECURITY-SIGNATURE"
    ...
    :cond_8
    :try_start_7
    const-string/jumbo v0, "ErrorId=-1"
    :try_end_7
    ...
    const-string/jumbo v3, "postXML setup to read reponse"
    ...
    :cond_c
    const-string/jumbo v6, "NetworkHandler"

    const-string/jumbo v7, "postXML do read response"
    ...
    const-string/jumbo v3, "NetworkHandler"

    new-instance v4, Ljava/lang/StringBuilder;

    invoke-direct {v4}, Ljava/lang/StringBuilder;-><init>()V

    const-string/jumbo v5, "postXML caught exception closing streams"
...
.method private static a(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    const-string/jumbo v2, " error endpoint - "
    ...
    const-string/jumbo v2, " error request - "
    ...
    const-string/jumbo v2, " error reply - "
...
.method public static final a()Z
    ...
    const-string/jumbo v1, "payButtonEnable"
...
.method static synthetic a(Lcom/paypal/android/a/b;Ljava/lang/String;Ljava/lang/String;)Z
    ...
    const-string/jumbo v0, "authorizationType"
    ...
    invoke-static {v3, v0, p2}, Lcom/paypal/android/a/m;->a(Ljava/lang/StringBuilder;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/StringBuilder;

    const-string/jumbo v0, "bypassEncryption"

    invoke-static {v3, v0, v1}, Lcom/paypal/android/a/m;->a(Ljava/lang/StringBuilder;Ljava/lang/String;Z)Ljava/lang/StringBuilder;

    :goto_1
    const-string/jumbo v0, "authorizeDevice"
    ...
    const-string/jumbo v2, "/DeviceAuthenticateUser"
...
.method private a(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Z
    ...
    const-string/jumbo v1, "createQuickPayment"
    ...
    const-string/jumbo v2, "parseDeviceAuthenticateUser"
    ...
    const-string/jumbo v1, "parseDeviceAuthenticateUser"

    const-string/jumbo v2, "null response from server"
    ...
    :cond_2
    const-string/jumbo v3, "pinEstablished"
    ...
    const-string/jumbo v1, "Not exactly one pinEstablished tag"
    ...
    const-string/jumbo v1, "Not exactly one sessionToken tag"
    ...
    const-string/jumbo v3, "deviceAuthorized"
    ...
    const-string/jumbo v1, "Not exactly one deviceAuthorized tag"
    ...
    const-string/jumbo v5, "AuthorizedDevice"
...
.method private a(Lorg/w3c/dom/Document;Ljava/lang/String;)Z
    ...
    :cond_5
    const-string/jumbo v0, "<SOAP-ENV:Body"
    ...
    const-string/jumbo v2, "FATAL_ERROR_ID"

    invoke-virtual {v1, v2, v3}, Landroid/content/Intent;->putExtra(Ljava/lang/String;Ljava/lang/String;)Landroid/content/Intent;

    move-result-object v7

    const-string/jumbo v1, "569060"
    ...
    const-string/jumbo v0, "ANDROID_no_personal_payments"
    ...
    const-string/jumbo v2, "CorrelationId"
    ...
    :cond_a
    const-string/jumbo v0, "FATAL_ERROR_MESSAGE"
    ...
    const-string/jumbo v0, "ANDROID_10001"
    ...
    const-string/jumbo v1, "ANDROID_580001_4"
    ...
    const-string/jumbo v1, "ANDROID_520009_2"
    ...
    const-string/jumbo v2, "FATAL_ERROR_MESSAGE"

    const-string/jumbo v3, "ANDROID_pin_creation_timeout"
...
.method public static b()Ljava/lang/String;
    ...
    :pswitch_0
    const-string/jumbo v0, "https://mobileclient.paypal.com/"
    ...
    :pswitch_2
    const-string/jumbo v0, "https://mobileclient.sandbox.paypal.com/"

    goto :goto_0

    :pswitch_3
    const-string/jumbo v0, "https://www.stage2mb101.paypal.com:10521/"
...
.method public static d()V
    ...
    const-string/jumbo v2, "waiting for thread to stop"
    ...
    const-string/jumbo v1, "thread has stopped"
...
.method static synthetic e(Lcom/paypal/android/a/b;)Z
    ...
    const-string/jumbo v1, "authorizationType"
    ...
    const-string/jumbo v1, "authorizeDevice"
...
.method private static g(Ljava/lang/String;)Z
    ...
    const-string/jumbo v0, "560027"

    aput-object v0, v3, v1

    const-string/jumbo v0, "580022"

    aput-object v0, v3, v2

    const/4 v0, 0x2

    const-string/jumbo v4, "580023"
...
.method static synthetic h(Lcom/paypal/android/a/b;)Ljava/lang/String;
    ...
    const-string/jumbo v2, "ExecutePayment/"
    ...
    const-string/jumbo v3, "sendPayment"
...
.method private static h(Ljava/lang/String;)Z
    ...
    const-string/jumbo v4, "10898"

    aput-object v4, v3, v0

    const/4 v0, 0x3

    const-string/jumbo v4, "10899"

    aput-object v4, v3, v0

    const/4 v0, 0x4

    const-string/jumbo v4, "520003"
...
.method private static i(Ljava/lang/String;)Z
    ...
    const-string/jumbo v4, "10800"

    aput-object v4, v3, v0

    const/4 v0, 0x3

    const-string/jumbo v4, "10801"

    aput-object v4, v3, v0

    const/4 v0, 0x4

    const-string/jumbo v4, "10802"

    aput-object v4, v3, v0

    const/4 v0, 0x5

    const-string/jumbo v4, "10804"

    aput-object v4, v3, v0

    const/4 v0, 0x6

    const-string/jumbo v4, "10805"

    aput-object v4, v3, v0

    const/4 v0, 0x7

    const-string/jumbo v4, "10806"

    aput-object v4, v3, v0

    const/16 v0, 0x8

    const-string/jumbo v4, "10808"

    aput-object v4, v3, v0

    const/16 v0, 0x9

    const-string/jumbo v4, "10809"

    aput-object v4, v3, v0

    const/16 v0, 0xa

    const-string/jumbo v4, "10810"

    aput-object v4, v3, v0

    const/16 v0, 0xb

    const-string/jumbo v4, "10811"

    aput-object v4, v3, v0

    const/16 v0, 0xc

    const-string/jumbo v4, "10812"

    aput-object v4, v3, v0

    const/16 v0, 0xd

    const-string/jumbo v4, "10813"

    aput-object v4, v3, v0

    const/16 v0, 0xe

    const-string/jumbo v4, "10815"

    aput-object v4, v3, v0

    const/16 v0, 0xf

    const-string/jumbo v4, "10819"

    aput-object v4, v3, v0

    const/16 v0, 0x10

    const-string/jumbo v4, "10820"

    aput-object v4, v3, v0

    const/16 v0, 0x11

    const-string/jumbo v4, "10821"

    aput-object v4, v3, v0

    const/16 v0, 0x12

    const-string/jumbo v4, "10822"

    aput-object v4, v3, v0

    const/16 v0, 0x13

    const-string/jumbo v4, "10823"

    aput-object v4, v3, v0

    const/16 v0, 0x14

    const-string/jumbo v4, "10824"

    aput-object v4, v3, v0

    const/16 v0, 0x15

    const-string/jumbo v4, "10825"

    aput-object v4, v3, v0

    const/16 v0, 0x16

    const-string/jumbo v4, "10849"

    aput-object v4, v3, v0

    const/16 v0, 0x17

    const-string/jumbo v4, "10850"

    aput-object v4, v3, v0

    const/16 v0, 0x18

    const-string/jumbo v4, "10858"

    aput-object v4, v3, v0

    const/16 v0, 0x19

    const-string/jumbo v4, "10859"

    aput-object v4, v3, v0

    const/16 v0, 0x1a

    const-string/jumbo v4, "10860"

    aput-object v4, v3, v0

    const/16 v0, 0x1b

    const-string/jumbo v4, "10861"

    aput-object v4, v3, v0

    const/16 v0, 0x1c

    const-string/jumbo v4, "10862"

    aput-object v4, v3, v0

    const/16 v0, 0x1d

    const-string/jumbo v4, "10863"

    aput-object v4, v3, v0

    const/16 v0, 0x1e

    const-string/jumbo v4, "10864"

    aput-object v4, v3, v0

    const/16 v0, 0x1f

    const-string/jumbo v4, "10867"

    aput-object v4, v3, v0

    const/16 v0, 0x20

    const-string/jumbo v4, "99999"
    ...
    const-string/jumbo v4, "520009"

    aput-object v4, v3, v0

    const/16 v0, 0x23

    const-string/jumbo v4, "539041"

    aput-object v4, v3, v0

    const/16 v0, 0x24

    const-string/jumbo v4, "540031"

    aput-object v4, v3, v0

    const/16 v0, 0x25

    const-string/jumbo v4, "550001"

    aput-object v4, v3, v0

    const/16 v0, 0x26

    const-string/jumbo v4, "550006"

    aput-object v4, v3, v0

    const/16 v0, 0x27

    const-string/jumbo v4, "559044"

    aput-object v4, v3, v0

    const/16 v0, 0x28

    const-string/jumbo v4, "560027"

    aput-object v4, v3, v0

    const/16 v0, 0x29

    const-string/jumbo v4, "569000"

    aput-object v4, v3, v0

    const/16 v0, 0x2a

    const-string/jumbo v4, "569042"

    aput-object v4, v3, v0

    const/16 v0, 0x2b

    const-string/jumbo v4, "569056"

    aput-object v4, v3, v0

    const/16 v0, 0x2c

    const-string/jumbo v4, "569060"

    aput-object v4, v3, v0

    const/16 v0, 0x2d

    const-string/jumbo v4, "579007"

    aput-object v4, v3, v0

    const/16 v0, 0x2e

    const-string/jumbo v4, "579017"

    aput-object v4, v3, v0

    const/16 v0, 0x2f

    const-string/jumbo v4, "579033"

    aput-object v4, v3, v0

    const/16 v0, 0x30

    const-string/jumbo v4, "579040"

    aput-object v4, v3, v0

    const/16 v0, 0x31

    const-string/jumbo v4, "579045"

    aput-object v4, v3, v0

    const/16 v0, 0x32

    const-string/jumbo v4, "579047"

    aput-object v4, v3, v0

    const/16 v0, 0x33

    const-string/jumbo v4, "579048"

    aput-object v4, v3, v0

    const/16 v0, 0x34

    const-string/jumbo v4, "580001"

    aput-object v4, v3, v0

    const/16 v0, 0x35

    const-string/jumbo v4, "580022"
    ...
    const-string/jumbo v4, "580028"

    aput-object v4, v3, v0

    const/16 v0, 0x38

    const-string/jumbo v4, "580030"

    aput-object v4, v3, v0

    const/16 v0, 0x39

    const-string/jumbo v4, "580031"

    aput-object v4, v3, v0

    const/16 v0, 0x3a

    const-string/jumbo v4, "580032"

    aput-object v4, v3, v0

    const/16 v0, 0x3b

    const-string/jumbo v4, "580033"

    aput-object v4, v3, v0

    const/16 v0, 0x3c

    const-string/jumbo v4, "580034"

    aput-object v4, v3, v0

    const/16 v0, 0x3d

    const-string/jumbo v4, "589009"

    aput-object v4, v3, v0

    const/16 v0, 0x3e

    const-string/jumbo v4, "589019"
...
.method private static j(Ljava/lang/String;)Ljava/lang/String;
    ...
    const-string/jumbo v3, "encryptPassword faulted "
...
.method private k(Ljava/lang/String;)Z
    ...
    const-string/jumbo v2, "Response contains an error, "
    ...
    const-string/jumbo v2, "Exception checking for error in response, "
...
.method private static p()Ljava/lang/String;
    ...
    :pswitch_0
    const-string/jumbo v0, "https://svcs.paypal.com/AdaptivePayments/"
    ...
    :pswitch_2
    const-string/jumbo v0, "https://svcs.sandbox.paypal.com/AdaptivePayments/"

    goto :goto_0

    :pswitch_3
    const-string/jumbo v0, "https://www.stage2mb101.paypal.com:10279/AdaptivePayments/"
...
.method private static q()Ljava/lang/String;
    ...
    :pswitch_0
    const-string/jumbo v0, "GMAdapter"
...
.method private s()Z
    ...
    const-string/jumbo v3, "SetPaymentOptions/"
    ...
    const-string/jumbo v4, "setPaymentOptions"
...
.method private t()Z
    ...
    const-string/jumbo v3, "GetAvailableShippingAddresses/"
    ...
    const-string/jumbo v4, "getAddresses"
...
.method private u()Z
    ...
    const-string/jumbo v3, "Preapproval/"
    ...
    const-string/jumbo v4, "createPreapprovalRequest"
...
.method private v()Z
    ...
    const-string/jumbo v2, "PreapprovalDetails/"
    ...
    const-string/jumbo v1, "FATAL_ERROR_ID"
    ...
    const-string/jumbo v1, "FATAL_ERROR_MESSAGE"

    const-string/jumbo v2, "ANDROID_preapproval_already_approved"
    ...
    const-string/jumbo v4, "ANDROID_preapproval_already_approved"
...
.method private w()Z
    ...
    const-string/jumbo v3, "ConfirmPreapproval/"
    ...
    const-string/jumbo v4, "confirmPreapprovalRequest"
...
.method private static x()Z
    ...
    const-string/jumbo v2, "ANDROID_simulator_payment_block"
    ...
    const-string/jumbo v4, "ANDROID_simulator_payment_block"
...
.method private y()Ljava/util/Hashtable;
    ...
    const-string/jumbo v3, "createPayment"

    invoke-static {v3, v1, v0, v2}, Lcom/paypal/android/a/b;->a(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V

    const-string/jumbo v0, "<errorId>580022</errorId>"
    ...
    const-string/jumbo v0, "ANDROID_580022"
    ...
    const-string/jumbo v2, "ANDROID_589009"
    ...
    const-string/jumbo v3, "589009"

    const-string/jumbo v4, "ANDROID_589009"
...
.method private z()Ljava/util/Hashtable;
    ...
    const-string/jumbo v3, "GetFundingPlans/"
    ...
    const-string/jumbo v4, "createFundingRequest"
    ...
    const-string/jumbo v2, "FundingPlans"
    ...
    const-string/jumbo v3, "ANDROID_589009"
...
.method public final a(ILjava/lang/Object;)V
    ...
    const-string/jumbo v2, "PaymentExecStatus"
    ...
    :pswitch_4
    const-string/jumbo v1, "FundingPlanId"
    ...
    :goto_1
    const-string/jumbo v2, "AvailableAddresses"
    ...
    const-string/jumbo v2, "ShippingAddressId"
...
.method public final a(Ljava/lang/String;)V
    ...
    :cond_0
    const-string/jumbo v0, "MPL Tracking"
    ...
    const-string/jumbo v1, "Preapproval"

    :cond_3
    :goto_2
    new-instance v3, Ljava/lang/StringBuilder;

    const-string/jumbo v4, "https://sstats.paypal-metrics.com/b/ss/paypalwireless/5/H.5--WAP/12345?pageName=android/"
    ...
    const-string/jumbo v3, "queueTrackingPost (), queue tracking "
...
.method public final i()V
    ...
    const-string/jumbo v2, "PaymentCurrencyID"
    ...
    const-string/jumbo v2, "CancelUrl"
    ...
    const-string/jumbo v0, "EACHRECEIVER"
    ...
    :pswitch_1
    const-string/jumbo v0, "PRIMARYRECEIVER"

    goto :goto_0

    :pswitch_2
    const-string/jumbo v0, "SECONDARYONLY"
...
.method public final k()I
    ...
    :cond_10
    const-string/jumbo v0, "PaymentCurrencyID"
