...
.method public final run()V
    ...
    const-string/jumbo v2, "mpl-review"
    ...
    const-string/jumbo v2, "usernameOrPhone"
    ...
    const-string/jumbo v5, "passwordOrPin"
    ...
    const-string/jumbo v1, "end LOGIN ok"
    ...
    const-string/jumbo v5, "Error during call to log in. "
    ...
    const-string/jumbo v2, "start QUICK_LOGIN"
    ...
    const-string/jumbo v1, "end QUICK_LOGIN ok"
    ...
    const-string/jumbo v6, "Error during call to log in. "
    ...
    :pswitch_3
    const-string/jumbo v0, "UPDATE_PAYMENT is supposed to be dead code"
    ...
    const-string/jumbo v2, "start CREATE_PAYMENT"
    ...
    const-string/jumbo v1, "end CREATE_PAYMENT ok"
    ...
    const-string/jumbo v2, "CREATE_PAYMENT"
    ...
    :pswitch_5
    const-string/jumbo v0, "QUICK_PAY is supposed to be dead code"
    ...
    const-string/jumbo v2, "start SEND_PAYMENT"
    ...
    const-string/jumbo v2, "CHANGE_STRING"
    ...
    const-string/jumbo v4, "mpl-success"
    ...
    const-string/jumbo v1, "end SEND_PAYMENT ok"
    ...
    const-string/jumbo v2, "SEND_PAYMENT"
    ...
    const-string/jumbo v2, "start FUNDING"
    ...
    const-string/jumbo v1, "end FUNDING ok"
    ...
    const-string/jumbo v2, "GET_SHIPPING_ADDRESSES"
    ...
    const-string/jumbo v2, "start CREATE_PIN"
    ...
    const-string/jumbo v1, "end CREATE_PIN ok"
    ...
    const-string/jumbo v2, "CREATE_PIN"
    ...
    const-string/jumbo v1, "start CHECK_AUTH"
    ...
    const-string/jumbo v1, "end CHECK_AUTH ok"
    ...
    const-string/jumbo v1, "start REMOVE_AUTH"
    ...
    const-string/jumbo v1, "end REMOVE_AUTH ok"
    ...
    const-string/jumbo v2, "PREAPPROVAL_DETAILS"
    ...
    const-string/jumbo v2, "PREAPPROVAL_CONFIRM"
    ...
    const-string/jumbo v2, "CREATE_PREAPPROVAL"
    ...
    const-string/jumbo v1, "thread exiting"
