...
.method public constructParser(IILorg/codehaus/jackson/ObjectCodec;Lorg/codehaus/jackson/sym/BytesToNameCanonicalizer;)Lorg/codehaus/jackson/smile/SmileParser;
    .locals 16
    .parameter "generalParserFeatures"
    ...
    const-string/jumbo v3, "Input does not start with Smile format header (first byte = 0x"
    ...
    const-string/jumbo v3, ") -- rather, it starts with \'"
    ...
    const-string/jumbo v3, "\' (plain JSON input?) -- can not parse"
    ...
    const-string/jumbo v3, ") and parser has REQUIRE_HEADER enabled: can not parse"
