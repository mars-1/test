...
.method private verify(Ljava/io/InputStream;Ljava/io/InputStream;)V
    ...
    const-string/jumbo v12, "Input and encoded differ, token #"
    ...
    const-string/jumbo v12, "; expected text \'"
    ...
    const-string/jumbo v12, "OK: verified "
    ...
    const-string/jumbo v12, " tokens (from "
    ...
    const-string/jumbo v12, " bytes of Smile encoded data), input and encoded contents are identical"
...
.method protected showUsage()V
    ...
    const-string/jumbo v2, "Usage: java "
    ...
    const-string/jumbo v2, " -e/-d [file]"
    ...
    const-string/jumbo v1, " (if no file given, reads from stdin -- always writes to stdout)"
    ...
    const-string/jumbo v1, " -d: decode Smile encoded input as JSON"
    ...
    const-string/jumbo v1, " -e: encode JSON (text) input as Smile"
    ...
    const-string/jumbo v1, " -v: encode JSON (text) input as Smile; read back, verify, do not write out"
