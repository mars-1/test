...
.method private static outputFullTriplet(I[BI)I
    ...
    .end local p2
    .local v2, offset:I
    sget-object v3, Lorg/codehaus/jackson/io/NumberOutput;->FULL_TRIPLETS_B:[B
...
.method public static outputInt(I[BI)I
    ...
    invoke-static {v5, v6, p1, p2}, Lorg/codehaus/jackson/io/NumberOutput;->outputLong(J[BI)I
    ...
    .line 149
    invoke-static {v4, p1, p2}, Lorg/codehaus/jackson/io/NumberOutput;->outputLeadingTriplet(I[BI)I
    ...
    .line 171
    invoke-static {v1, p1, p2}, Lorg/codehaus/jackson/io/NumberOutput;->outputFullTriplet(I[BI)I

    move-result p2

    .line 175
    :goto_4
    invoke-static {v4, p1, p2}, Lorg/codehaus/jackson/io/NumberOutput;->outputFullTriplet(I[BI)I
    ...
    .restart local v4       #thousands:I
    :cond_8
    invoke-static {v1, p1, p2}, Lorg/codehaus/jackson/io/NumberOutput;->outputLeadingTriplet(I[BI)I
...
.method public static outputLong(J[BI)I
    ...
    .line 240
    sget-wide v9, Lorg/codehaus/jackson/io/NumberOutput;->MIN_INT_AS_LONG:J
    ...
    invoke-static {v9, p2, p3}, Lorg/codehaus/jackson/io/NumberOutput;->outputInt(I[BI)I
    ...
    .line 245
    sget-object v9, Lorg/codehaus/jackson/io/NumberOutput;->SMALLEST_LONG:Ljava/lang/String;
    ...
    .local v7, ptr:I
    :goto_2
    sget-wide v9, Lorg/codehaus/jackson/io/NumberOutput;->MAX_INT_AS_LONG:J
    ...
    .line 265
    sget-wide v9, Lorg/codehaus/jackson/io/NumberOutput;->THOUSAND_L:J
    ...
    .line 267
    .local v8, triplet:I
    invoke-static {v8, p2, v7}, Lorg/codehaus/jackson/io/NumberOutput;->outputFullTriplet(I[BI)I
    ...
    .end local v8           #triplet:I
    :cond_6
    invoke-static {v1, p2, v6}, Lorg/codehaus/jackson/io/NumberOutput;->outputLeadingTriplet(I[BI)I
