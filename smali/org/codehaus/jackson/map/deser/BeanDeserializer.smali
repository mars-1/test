...
.method public deserializeFromNumber(Lorg/codehaus/jackson/JsonParser;Lorg/codehaus/jackson/map/DeserializationContext;)Ljava/lang/Object;
    ...
    const-string/jumbo v1, "no suitable creator method found to deserialize from JSON Number"
...
.method public deserializeFromObject(Lorg/codehaus/jackson/JsonParser;Lorg/codehaus/jackson/map/DeserializationContext;)Ljava/lang/Object;
    ...
    const-string/jumbo v5, "Can not instantiate abstract type "
    ...
    const-string/jumbo v5, " (need to add/enable type information?)"
    ...
    const-string/jumbo v5, "No suitable constructor found for type "
    ...
    const-string/jumbo v5, ": can not instantiate from JSON object (need to add/enable type information?)"
...
.method public deserializeFromString(Lorg/codehaus/jackson/JsonParser;Lorg/codehaus/jackson/map/DeserializationContext;)Ljava/lang/Object;
    ...
    const-string/jumbo v1, "no suitable creator method found to deserialize from JSON String"
...
.method public properties()Ljava/util/Iterator;
    ...
    const-string/jumbo v1, "Can only call before BeanDeserializer has been resolved"
...
.method public resolve(Lorg/codehaus/jackson/map/DeserializationConfig;Lorg/codehaus/jackson/map/DeserializerProvider;)V
    ...
    const-string/jumbo v18, "Can not handle managed/back reference \'"
    ...
    const-string/jumbo v18, "\': no back reference property found from type "
    ...
    const-string/jumbo v18, "\': value deserializer is of type ContainerDeserializer, but content type is not handled by a BeanDeserializer "
    ...
    const-string/jumbo v18, " (instead it\'s of type "
    ...
    const-string/jumbo v18, "Can not handle managed/back reference for abstract types (property "
    ...
    const-string/jumbo v18, "\': type for value deserializer is not BeanDeserializer or ContainerDeserializer, but "
    ...
    const-string/jumbo v18, "\': back reference type ("
    ...
    const-string/jumbo v18, ") not compatible with managed type ("
