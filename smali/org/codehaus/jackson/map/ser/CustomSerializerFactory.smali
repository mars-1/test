...
.method protected _findInterfaceMapping(Ljava/lang/Class;Lorg/codehaus/jackson/map/type/ClassKey;)Lorg/codehaus/jackson/map/JsonSerializer;
    ...
    .line 280
    iget-object v5, p0, Lorg/codehaus/jackson/map/ser/CustomSerializerFactory;->_interfaceMappings:Ljava/util/HashMap;
...
.method public addSpecificMapping(Ljava/lang/Class;Lorg/codehaus/jackson/map/JsonSerializer;)V
    ...
    const-string/jumbo v3, "Can not add specific mapping for an interface ("
    ...
    const-string/jumbo v3, "Can not add specific mapping for an abstract class ("
...
.method public createSerializer(Lorg/codehaus/jackson/map/SerializationConfig;Lorg/codehaus/jackson/type/JavaType;Lorg/codehaus/jackson/map/BeanProperty;)Lorg/codehaus/jackson/map/JsonSerializer;
    ...
    invoke-virtual {p0, v1, p1}, Lorg/codehaus/jackson/map/ser/CustomSerializerFactory;->findCustomSerializer(Ljava/lang/Class;Lorg/codehaus/jackson/map/SerializationConfig;)Lorg/codehaus/jackson/map/JsonSerializer;
    ...
    .restart local v0       #ser:Lorg/codehaus/jackson/map/JsonSerializer;,"Lorg/codehaus/jackson/map/JsonSerializer<*>;"
    :cond_0
...
.method protected findCustomSerializer(Ljava/lang/Class;Lorg/codehaus/jackson/map/SerializationConfig;)Lorg/codehaus/jackson/map/JsonSerializer;
    ...
    iget-object v3, p0, Lorg/codehaus/jackson/map/ser/CustomSerializerFactory;->_directClassMappings:Ljava/util/HashMap;
    ...
    .end local v2           #ser:Lorg/codehaus/jackson/map/JsonSerializer;,"Lorg/codehaus/jackson/map/JsonSerializer<*>;"
    check-cast v2, Lorg/codehaus/jackson/map/JsonSerializer;

    .line 234
    .restart local v2       #ser:Lorg/codehaus/jackson/map/JsonSerializer;,"Lorg/codehaus/jackson/map/JsonSerializer<*>;"
    if-eqz v2, :cond_0
    ...
    .line 241
    iget-object v3, p0, Lorg/codehaus/jackson/map/ser/CustomSerializerFactory;->_enumSerializerOverride:Lorg/codehaus/jackson/map/JsonSerializer;
    ...
    .line 248
    :cond_1
    iget-object v3, p0, Lorg/codehaus/jackson/map/ser/CustomSerializerFactory;->_transitiveClassMappings:Ljava/util/HashMap;
    ...
    .line 250
    invoke-virtual {v1, v0}, Lorg/codehaus/jackson/map/type/ClassKey;->reset(Ljava/lang/Class;)V
    ...
    .line 261
    invoke-virtual {v1, p1}, Lorg/codehaus/jackson/map/type/ClassKey;->reset(Ljava/lang/Class;)V
    ...
    .line 267
    invoke-virtual {p0, v0, v1}, Lorg/codehaus/jackson/map/ser/CustomSerializerFactory;->_findInterfaceMapping(Ljava/lang/Class;Lorg/codehaus/jackson/map/type/ClassKey;)Lorg/codehaus/jackson/map/JsonSerializer;
...
.method public setEnumSerializer(Lorg/codehaus/jackson/map/JsonSerializer;)V
    ...
    .prologue
    .line 198
    .local p1, enumSer:Lorg/codehaus/jackson/map/JsonSerializer;,"Lorg/codehaus/jackson/map/JsonSerializer<*>;"
...
.method public withConfig(Lorg/codehaus/jackson/map/SerializerFactory$Config;)Lorg/codehaus/jackson/map/SerializerFactory;
    ...
    const-string/jumbo v2, "Subtype of CustomSerializerFactory ("
    ...
    const-string/jumbo v2, ") has not properly overridden method \'withAdditionalSerializers\': can not instantiate subtype with "

    invoke-virtual {v1, v2}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v1

    const-string/jumbo v2, "additional serializer definitions"
