...
.method protected final _copyTo(Ljava/lang/Object;I[Ljava/lang/Object;I)V
    ...
    .line 208
    .local v3, ptr:I
    iget-object v2, p0, Lorg/codehaus/jackson/map/util/ObjectBuffer;->_bufferHead:Lorg/codehaus/jackson/map/util/ObjectBuffer$Node;

    .local v2, n:Lorg/codehaus/jackson/map/util/ObjectBuffer$Node;
    :goto_0
    if-eqz v2, :cond_0
...
.method public appendCompletedChunk([Ljava/lang/Object;)[Ljava/lang/Object;
    ...
    .prologue
    .line 96
    new-instance v1, Lorg/codehaus/jackson/map/util/ObjectBuffer$Node;

    invoke-direct {v1, p1}, Lorg/codehaus/jackson/map/util/ObjectBuffer$Node;-><init>([Ljava/lang/Object;)V

    .line 97
    .local v1, next:Lorg/codehaus/jackson/map/util/ObjectBuffer$Node;
    iget-object v2, p0, Lorg/codehaus/jackson/map/util/ObjectBuffer;->_bufferHead:Lorg/codehaus/jackson/map/util/ObjectBuffer$Node;

    if-nez v2, :cond_0

    .line 98
    iput-object v1, p0, Lorg/codehaus/jackson/map/util/ObjectBuffer;->_bufferTail:Lorg/codehaus/jackson/map/util/ObjectBuffer$Node;

    iput-object v1, p0, Lorg/codehaus/jackson/map/util/ObjectBuffer;->_bufferHead:Lorg/codehaus/jackson/map/util/ObjectBuffer$Node;
    ...
    .line 104
    .local v0, len:I
    iget v2, p0, Lorg/codehaus/jackson/map/util/ObjectBuffer;->_bufferedEntryCount:I

    add-int/2addr v2, v0

    iput v2, p0, Lorg/codehaus/jackson/map/util/ObjectBuffer;->_bufferedEntryCount:I
    ...
    .end local v0           #len:I
    :cond_0
    iget-object v2, p0, Lorg/codehaus/jackson/map/util/ObjectBuffer;->_bufferTail:Lorg/codehaus/jackson/map/util/ObjectBuffer$Node;

    invoke-virtual {v2, v1}, Lorg/codehaus/jackson/map/util/ObjectBuffer$Node;->linkNext(Lorg/codehaus/jackson/map/util/ObjectBuffer$Node;)V
...
.method public completeAndClearBuffer([Ljava/lang/Object;ILjava/util/List;)V
    ...
    iget-object v3, p0, Lorg/codehaus/jackson/map/util/ObjectBuffer;->_bufferHead:Lorg/codehaus/jackson/map/util/ObjectBuffer$Node;

    .local v3, n:Lorg/codehaus/jackson/map/util/ObjectBuffer$Node;
    :goto_0
    if-eqz v3, :cond_1

    .line 158
    invoke-virtual {v3}, Lorg/codehaus/jackson/map/util/ObjectBuffer$Node;->getData()[Ljava/lang/Object;
    ...
    .line 157
    :cond_0
    invoke-virtual {v3}, Lorg/codehaus/jackson/map/util/ObjectBuffer$Node;->next()Lorg/codehaus/jackson/map/util/ObjectBuffer$Node;
