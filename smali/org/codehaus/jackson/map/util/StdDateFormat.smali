...
.field static final DATE_FORMAT_PLAIN:Ljava/text/SimpleDateFormat; = null
...
.method static constructor <clinit>()V
    ...
    sput-object v1, Lorg/codehaus/jackson/map/util/StdDateFormat;->ALL_FORMATS:[Ljava/lang/String;
    ...
    .line 92
    new-instance v1, Lorg/codehaus/jackson/map/util/StdDateFormat;

    invoke-direct {v1}, Lorg/codehaus/jackson/map/util/StdDateFormat;-><init>()V

    sput-object v1, Lorg/codehaus/jackson/map/util/StdDateFormat;->instance:Lorg/codehaus/jackson/map/util/StdDateFormat;
...
.method public parse(Ljava/lang/String;)Ljava/util/Date;
    ...
    invoke-virtual {p0, p1, v4}, Lorg/codehaus/jackson/map/util/StdDateFormat;->parse(Ljava/lang/String;Ljava/text/ParsePosition;)Ljava/util/Date;
    ...
    sget-object v0, Lorg/codehaus/jackson/map/util/StdDateFormat;->ALL_FORMATS:[Ljava/lang/String;
...
.method public parse(Ljava/lang/String;Ljava/text/ParsePosition;)Ljava/util/Date;
    ...
    invoke-static {p1, v2}, Lorg/codehaus/jackson/io/NumberInput;->inLongRange(Ljava/lang/String;Z)Z
...
.method protected parseAsISO8601(Ljava/lang/String;Ljava/text/ParsePosition;)Ljava/util/Date;
    ...
    .line 260
    iget-object v1, p0, Lorg/codehaus/jackson/map/util/StdDateFormat;->_formatPlain:Ljava/text/SimpleDateFormat;
    ...
    .line 262
    sget-object v5, Lorg/codehaus/jackson/map/util/StdDateFormat;->DATE_FORMAT_PLAIN:Ljava/text/SimpleDateFormat;
    ...
    iput-object v1, p0, Lorg/codehaus/jackson/map/util/StdDateFormat;->_formatPlain:Ljava/text/SimpleDateFormat;
    ...
    .line 265
    iget-object v1, p0, Lorg/codehaus/jackson/map/util/StdDateFormat;->_formatISO8601_z:Ljava/text/SimpleDateFormat;
    ...
    .line 267
    sget-object v5, Lorg/codehaus/jackson/map/util/StdDateFormat;->DATE_FORMAT_ISO8601_Z:Ljava/text/SimpleDateFormat;
    ...
    iput-object v1, p0, Lorg/codehaus/jackson/map/util/StdDateFormat;->_formatISO8601_z:Ljava/text/SimpleDateFormat;
    ...
    .line 299
    .restart local v1       #df:Ljava/text/SimpleDateFormat;
    iget-object v5, p0, Lorg/codehaus/jackson/map/util/StdDateFormat;->_formatISO8601:Ljava/text/SimpleDateFormat;

    if-nez v5, :cond_0

    .line 300
    sget-object v5, Lorg/codehaus/jackson/map/util/StdDateFormat;->DATE_FORMAT_ISO8601:Ljava/text/SimpleDateFormat;
    ...
    iput-object v1, p0, Lorg/codehaus/jackson/map/util/StdDateFormat;->_formatISO8601:Ljava/text/SimpleDateFormat;
