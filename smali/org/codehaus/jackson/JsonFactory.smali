...
.method public createJsonGenerator(Ljava/io/File;Lorg/codehaus/jackson/JsonEncoding;)Lorg/codehaus/jackson/JsonGenerator;
    ...
    invoke-virtual {p0, v1, v3}, Lorg/codehaus/jackson/JsonFactory;->_createContext(Ljava/lang/Object;Z)Lorg/codehaus/jackson/io/IOContext;
    ...
    .line 752
    iget-object v3, p0, Lorg/codehaus/jackson/JsonFactory;->_outputDecorator:Lorg/codehaus/jackson/io/OutputDecorator;
    ...
    invoke-virtual {v3, v0, v1}, Lorg/codehaus/jackson/io/OutputDecorator;->decorate(Lorg/codehaus/jackson/io/IOContext;Ljava/io/OutputStream;)Ljava/io/OutputStream;

    move-result-object v1

    .line 755
    :cond_0
    invoke-virtual {p0, v1, v0}, Lorg/codehaus/jackson/JsonFactory;->_createUTF8JsonGenerator(Ljava/io/OutputStream;Lorg/codehaus/jackson/io/IOContext;)Lorg/codehaus/jackson/JsonGenerator;
    ...
    invoke-virtual {v3, v0, v2}, Lorg/codehaus/jackson/io/OutputDecorator;->decorate(Lorg/codehaus/jackson/io/IOContext;Ljava/io/Writer;)Ljava/io/Writer;
...
.method public createJsonParser(Ljava/io/File;)Lorg/codehaus/jackson/JsonParser;
    ...
    invoke-virtual {v2, v0, v1}, Lorg/codehaus/jackson/io/InputDecorator;->decorate(Lorg/codehaus/jackson/io/IOContext;Ljava/io/InputStream;)Ljava/io/InputStream;
...
.method public createJsonParser(Ljava/lang/String;)Lorg/codehaus/jackson/JsonParser;
    ...
    invoke-virtual {v2, v0, v1}, Lorg/codehaus/jackson/io/InputDecorator;->decorate(Lorg/codehaus/jackson/io/IOContext;Ljava/io/Reader;)Ljava/io/Reader;

    move-result-object v1

    .line 643
    :cond_0
    invoke-virtual {p0, v1, v0}, Lorg/codehaus/jackson/JsonFactory;->_createJsonParser(Ljava/io/Reader;Lorg/codehaus/jackson/io/IOContext;)Lorg/codehaus/jackson/JsonParser;
...
.method public createJsonParser([B)Lorg/codehaus/jackson/JsonParser;
    ...
    invoke-virtual {v2, v0, p1, v4, v3}, Lorg/codehaus/jackson/io/InputDecorator;->decorate(Lorg/codehaus/jackson/io/IOContext;[BII)Ljava/io/InputStream;
    ...
    invoke-virtual {p0, p1, v4, v2, v0}, Lorg/codehaus/jackson/JsonFactory;->_createJsonParser([BIILorg/codehaus/jackson/io/IOContext;)Lorg/codehaus/jackson/JsonParser;
...
.method public createJsonParser([BII)Lorg/codehaus/jackson/JsonParser;
    ...
    invoke-virtual {v2, v0, p1, p2, p3}, Lorg/codehaus/jackson/io/InputDecorator;->decorate(Lorg/codehaus/jackson/io/IOContext;[BII)Ljava/io/InputStream;
