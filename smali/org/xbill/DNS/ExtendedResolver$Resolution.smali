...
.method public constructor <init>(Lorg/xbill/DNS/ExtendedResolver;Lorg/xbill/DNS/Message;)V
    ...
    invoke-static {p1}, Lorg/xbill/DNS/ExtendedResolver;->access$0(Lorg/xbill/DNS/ExtendedResolver;)Ljava/util/List;
    ...
    new-array v6, v6, [Lorg/xbill/DNS/Resolver;

    invoke-interface {v1, v6}, Ljava/util/List;->toArray([Ljava/lang/Object;)[Ljava/lang/Object;

    move-result-object v6

    check-cast v6, [Lorg/xbill/DNS/Resolver;

    iput-object v6, p0, Lorg/xbill/DNS/ExtendedResolver$Resolution;->resolvers:[Lorg/xbill/DNS/Resolver;

    .line 35
    #getter for: Lorg/xbill/DNS/ExtendedResolver;->loadBalance:Z
    invoke-static {p1}, Lorg/xbill/DNS/ExtendedResolver;->access$1(Lorg/xbill/DNS/ExtendedResolver;)Z
    ...
    invoke-static {p1}, Lorg/xbill/DNS/ExtendedResolver;->access$2(Lorg/xbill/DNS/ExtendedResolver;)I

    move-result v6

    add-int/lit8 v7, v6, 0x1

    #setter for: Lorg/xbill/DNS/ExtendedResolver;->lbStart:I
    invoke-static {p1, v7}, Lorg/xbill/DNS/ExtendedResolver;->access$3(Lorg/xbill/DNS/ExtendedResolver;I)V
    ...
    #setter for: Lorg/xbill/DNS/ExtendedResolver;->lbStart:I
    invoke-static {p1, v6}, Lorg/xbill/DNS/ExtendedResolver;->access$3(Lorg/xbill/DNS/ExtendedResolver;I)V
    ...
    .line 46
    new-array v4, v2, [Lorg/xbill/DNS/Resolver;

    .line 47
    .local v4, shuffle:[Lorg/xbill/DNS/Resolver;
    const/4 v0, 0x0
    ...
    .line 51
    iput-object v4, p0, Lorg/xbill/DNS/ExtendedResolver$Resolution;->resolvers:[Lorg/xbill/DNS/Resolver;

    .line 54
    .end local v0           #i:I
    .end local v2           #nresolvers:I
    .end local v4           #shuffle:[Lorg/xbill/DNS/Resolver;
    ...
    iput-object v6, p0, Lorg/xbill/DNS/ExtendedResolver$Resolution;->sent:[I
    ...
    iput-object v6, p0, Lorg/xbill/DNS/ExtendedResolver$Resolution;->inprogress:[Ljava/lang/Object;

    .line 56
    #getter for: Lorg/xbill/DNS/ExtendedResolver;->retries:I
    invoke-static {p1}, Lorg/xbill/DNS/ExtendedResolver;->access$4(Lorg/xbill/DNS/ExtendedResolver;)I

    move-result v6

    iput v6, p0, Lorg/xbill/DNS/ExtendedResolver$Resolution;->retries:I
    ...
    .restart local v2       #nresolvers:I
    .restart local v4       #shuffle:[Lorg/xbill/DNS/Resolver;
...
.method public handleException(Ljava/lang/Object;Ljava/lang/Exception;)V
    ...
    iget-object v2, p0, Lorg/xbill/DNS/ExtendedResolver$Resolution;->sent:[I

    aget v2, v2, v0

    if-ne v2, v5, :cond_5

    iget-object v2, p0, Lorg/xbill/DNS/ExtendedResolver$Resolution;->resolvers:[Lorg/xbill/DNS/Resolver;
    ...
    .line 190
    :cond_6
    iget-object v2, p0, Lorg/xbill/DNS/ExtendedResolver$Resolution;->thrown:Ljava/lang/Throwable;
    ...
    .line 219
    iget-object v2, p0, Lorg/xbill/DNS/ExtendedResolver$Resolution;->listener:Lorg/xbill/DNS/ResolverListener;
    ...
    iput-object v2, p0, Lorg/xbill/DNS/ExtendedResolver$Resolution;->thrown:Ljava/lang/Throwable;

    .line 230
    :cond_10
    iget-object v3, p0, Lorg/xbill/DNS/ExtendedResolver$Resolution;->listener:Lorg/xbill/DNS/ResolverListener;

    iget-object v2, p0, Lorg/xbill/DNS/ExtendedResolver$Resolution;->thrown:Ljava/lang/Throwable;

    check-cast v2, Ljava/lang/Exception;

    invoke-interface {v3, p0, v2}, Lorg/xbill/DNS/ResolverListener;->handleException(Ljava/lang/Object;Ljava/lang/Exception;)V
...
.method public send(I)V
    ...
    invoke-interface {v2, v3, p0}, Lorg/xbill/DNS/Resolver;->sendAsync(Lorg/xbill/DNS/Message;Lorg/xbill/DNS/ResolverListener;)Ljava/lang/Object;
...
.method public start()Lorg/xbill/DNS/Message;
    ...
    .line 128
    const-string/jumbo v2, "ExtendedResolver failure"
