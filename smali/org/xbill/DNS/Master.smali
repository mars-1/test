...
.method private parseTTLClassAndType()V
    ...
    const-string/jumbo v4, "missing TTL"
...
.method private startGenerate()V
    ...
    const-string/jumbo v11, "Invalid $GENERATE range specifier: "
    ...
    const-string/jumbo v11, "$GENERATE does not support "
...
.method public _nextRecord()Lorg/xbill/DNS/Record;
    ...
    const-string/jumbo v5, "no owner"
    ...
    .end local v12           #newfile:Ljava/io/File;
    :cond_e
    const-string/jumbo v4, "$GENERATE"
    ...
    .line 346
    const-string/jumbo v5, "cannot nest $GENERATE"
    ...
    const-string/jumbo v6, "Invalid directive: "
