...
.method public connect()V
    ...
    const-string/jumbo v6, "Already connected to a server."
    ...
    .line 202
    const-string/jumbo v7, "xmpp"

    const-string/jumbo v8, "urn:xmpp:xbosh"
    ...
    .line 203
    const-string/jumbo v7, "urn:xmpp:xbosh"

    const-string/jumbo v8, "version"

    const-string/jumbo v9, "xmpp"
    ...
    const-string/jumbo v6, "Timeout reached for the connection to "
    ...
    const-string/jumbo v7, "Can\'t connect to "
...
.method public disconnect(Lorg/jivesoftware/smack/packet/Presence;)V
    ...
    .line 456
    :cond_2
    iget-object v2, p0, Lorg/jivesoftware/smack/BOSHConnection;->sendListeners:Ljava/util/Map;

    invoke-interface {v2}, Ljava/util/Map;->clear()V

    .line 457
    iget-object v2, p0, Lorg/jivesoftware/smack/BOSHConnection;->recvListeners:Ljava/util/Map;

    invoke-interface {v2}, Ljava/util/Map;->clear()V

    .line 458
    iget-object v2, p0, Lorg/jivesoftware/smack/BOSHConnection;->collectors:Ljava/util/Collection;

    invoke-interface {v2}, Ljava/util/Collection;->clear()V

    .line 459
    iget-object v2, p0, Lorg/jivesoftware/smack/BOSHConnection;->interceptors:Ljava/util/Map;
...
.method protected send(Lcom/kenai/jbosh/ComposableBody;)V
    ...
    const-string/jumbo v1, "Not connected to a server!"
    ...
    const-string/jumbo v1, "Body mustn\'t be null!"
    ...
    .line 563
    const-string/jumbo v1, "http://jabber.org/protocol/httpbind"
...
.method protected shutdown(Lorg/jivesoftware/smack/packet/Presence;)V
    ...
    const-string/jumbo v3, "urn:xmpp:xbosh"
